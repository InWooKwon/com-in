...
public class QnABoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),QnABoardWriteActivity.class);
                ...
                try {
                    ...
                    cs.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            {
                                if(!((board.getTag1() != 0 && insuranceList.get(board.getTag1()-1).getCompany().equals(adapterView.getItemAtPosition(position))) ||
                                        (board.getTag2() != 0 && insuranceList.get(board.getTag2()-1).getCompany().equals(adapterView.getItemAtPosition(position))) ||
                                        (board.getTag3() != 0 && insuranceList.get(board.getTag3()-1).getCompany().equals(adapterView.getItemAtPosition(position))) ||
                                        (board.getTag4() != 0 && insuranceList.get(board.getTag4()-1).getCompany().equals(adapterView.getItemAtPosition(position))) ||
                                        (board.getTag5() != 0 && insuranceList.get(board.getTag5()-1).getCompany().equals(adapterView.getItemAtPosition(position))) || position == 0))
                                    continue;
                                if(!((board.getTag1() != 0 && insuranceList.get(board.getTag1()-1).getProductType().equals(selectType)) ||
                                        (board.getTag2() != 0 && insuranceList.get(board.getTag2()-1).getProductType().equals(selectType)) ||
                                        (board.getTag3() != 0 && insuranceList.get(board.getTag3()-1).getProductType().equals(selectType)) ||
                                        (board.getTag4() != 0 && insuranceList.get(board.getTag4()-1).getProductType().equals(selectType)) ||
                                        (board.getTag5() != 0 && insuranceList.get(board.getTag5()-1).getProductType().equals(selectType)) || selectType.equals("전체보기")))
                                    continue;
    ...
    public void addBoardView(Post board){
        ...
        rl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(v.getContext(), QnABoardViewActivity.class);
                intent.putExtra("insurancelist",insuranceList);
